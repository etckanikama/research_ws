...
// numはひげを追加するごとに書き換える
const int POLYGON_NUM = 40; // sbのポリゴンの数は駐車場加えて24(x_min,x_max,y_min,y_max)
...
int main(int argc, char **argv)
{
    ...
    ss << "/home/hirayama-d/research_ws/src/sim/20240101_oregatukutta_1.5_hige/path_route1/csv/path_route1_" << std::fixed << std::setprecision(1) << param_global_init_x << "_"<< std::fixed << std::setprecision(1) << param_global_init_y << "_" << std::fixed << std::setprecision(2) << param_global_init_yaw <<".csv";
