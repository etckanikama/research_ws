...
int main(int argc, char** argv)
{
  ...
  while (ros::ok())
  {
    ...
    m4.scale.y = 2;
    m4.scale.z = 0.01;
    m4.pose.position.x = 3.6;
    m4.pose.position.y = -1.5;
    ...
    m6.scale.y = 2;
    m6.scale.z = 0.01;
    m6.pose.position.x = 4.6;
    m6.pose.position.y = -1.5;
    ...
    m7.scale.y = 0.075;
    m7.scale.z = 0.01;
    m7.pose.position.x = 8.1; // 中心7で上下に3mずつ
    ...
    m8.scale.y = 0.075;
    m8.scale.z = 0.01;
    m8.pose.position.x = 8.1; // 中心7で上下に3mずつ
