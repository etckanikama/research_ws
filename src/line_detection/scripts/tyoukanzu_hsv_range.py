...
cv2.drawMarker(rgb_img, (240, 80), (0,0,255), cv2.MARKER_TILTED_CROSS, markerSize=10, thickness=5)
cv2.drawMarker(rgb_img, (420, 80), (0,0,255), cv2.MARKER_TILTED_CROSS, markerSize=10, thickness=5)
cv2.drawMarker(rgb_img, (40, 180), (0,0,255), cv2.MARKER_TILTED_CROSS, markerSize=10, thickness=5)
cv2.drawMarker(rgb_img, (620, 180), (0,0,255), cv2.MARKER_TILTED_CROSS, markerSize=10, thickness=5)
...
while(1):
    ...
    dst_img = cv2.warpPerspective(mask_img, M, (500, 500))
	# 鳥瞰図変換
