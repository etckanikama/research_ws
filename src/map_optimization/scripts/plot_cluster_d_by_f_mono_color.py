...
# 元の地図：reoute1:path1ーーーーーーーーーーーーーーーーーーーーー
...
# path2
# file_path ="/home/hirayama-d/research_ws/src/sim/20240101_oregatukutta_1.5_hige/path_route1_reverse/csv/output_eigen_path_route1_reverse.csv"
# ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー

# 被覆問題の地図
# file_path = "/home/hirayama-d/research_ws/src/sim/20240101_after_set_covering_route1_tougou/path_route1/csv/output_eigen_set_covering_route1.csv"
# path2
...
for rectangle in rectangles:
    ...
    plt.fill(y_coords, x_coords, color='blue', alpha=0.2)
