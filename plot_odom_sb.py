...
plt.scatter(robot_y,robot_x,label="odometry", s=1)
plt.scatter(estimate_odom_y,estimate_odom_x,label="estimate_value", s=1)
plt.scatter(amcl_pose_y,amcl_pose_x,label="amcl_value", s=1)
