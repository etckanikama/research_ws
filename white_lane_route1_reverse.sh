...
for initial_y in $(seq -3.61 0.1 0.0)
do
    # launchファイルを実行
    ...
    # 数秒待つ（例：15秒）
    sleep 10
    scrot "matching-10.7-${initial_y}-1.57.png" -u -e 'mv $f /home/hirayama-d/research_ws/src/sim/20231227_re_route1/output/matching'
...
do
    ...
    # 数秒待つ（例：15秒）
    sleep 10
    scrot "matching-${initial_x}-0.0--3.14.png" -u -e 'mv $f /home/hirayama-d/research_ws/src/sim/20231227_re_route1/output/matching'
